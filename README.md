...
4. **deploy** - стадия деплоя
   ...
   Стадия запускается вручную с использованием скрипта ```src/deploy.sh``` и работает с двумя машинами. Заранее было настроено ssh-соединение между ними. На данной стадии происходит копирование файлов, полученных после сборки программ с одной машины на другую при помощи ssh. В результате на второй машине появляются готовые к работе утилиты cat и grep.
